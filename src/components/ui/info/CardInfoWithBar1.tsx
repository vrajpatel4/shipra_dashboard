...
const CardInfoWithBar1Component: React.FC<TCardInfoWithBar> = ({
  listItems,
  title,
}) => {
                        ...
                        <div key={index} className="flex items-center gap-4">
                          ...
                          <div
                            className={`w-16 text-right text-sm font-semibold ${
                              res.value >= 0 ? "text-green-600" : "text-red-500"
                            }`}
                          >
                            {res.value.toFixed(2)}%
                          </div>
...
export const CardInfoWithBar1 = memo(CardInfoWithBar1Component);
CardInfoWithBar1.displayName = "CardInfoWithBar1";
